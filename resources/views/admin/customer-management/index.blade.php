...
@section('content')
    ...
    <h1 class="text-dark">Danh sách khách hàng</h1>
    <div class="admin-customer-option-list-customer d-flex justify-content-between">
        <a href="{{ route('admin.customer.add') }}" class="btn btn-success"><b>Thêm khách hàng</b></a>
                ...
                @foreach ($customers as $customer)
                    <tr>
                        ...
                        <td style="width:10%;display:none;" class="table-tr-td-avatar">
                            <img class="table-tr-td-img" src="{{ !empty($customer->avatar) ? asset('storage/images/customer-images/'.$customer->avatar) :  asset('storage/images/customer-images/user_1.png')}} "  alt="" style="width: 100%; display:none;"/>
                        </td>
                        <td>{{ $customer->name }}</td>
                        ...
                        <td class="text-center">
                            <a href="{{ route('admin.customer.edit', ['customer_id' => $customer->id]) }}" class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                        </td>
                        <td class="text-center">
